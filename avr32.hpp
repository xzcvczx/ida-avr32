 ...
 *      ALL RIGHTS RESERVED.
 *
 *      Atmel AVR - 32-bit RISC processor
 *
 */
...
#define PLFM_AVR32  0x74666

enum avr32_idpspec {
  o_reglist = o_idpspec0
};

#define regmod specflag1
#define reglist_type specflag2

enum avr32_specflag1 {
  of_plain = 0,
  of_predec,
  of_postinc,
  of_lshift = 0x40,
...
enum RegNo
{
  ...
  rR8,    rR9,   rR10,  rR11,  rR12,  rSP,   rLR,   rPC,
...
void idaapi avr32_segstart(outctx_t &ctx, segment_t *seg);
void idaapi avr32_segend(outctx_t &ctx, segment_t *seg);
void idaapi avr32_assumes(outctx_t &ctx);         // function to produce assume directives
